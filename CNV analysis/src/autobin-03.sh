...
cnvkit.py autobin $WORKSPACE/resistant_tumors/BAM_files/D10SRO406_DL_merged_fixed.bam \
		-f $WORKSPACE/FVB-NJ_reference_genome/Mus_musculus_fvbnj.FVB_NJ_v1.dna.toplevel.fa \
		-g $WORKSPACE/resistant_tumors/access.FVB-NJ-fa.bed \
		-t $WORKSPACE/resistant_tumors/GCA_001624535.1_FVB_NK_v1.ensGene.bed \
